...
d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.6",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.6",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return c>e?"top":!1;if("bottom"==this.affixed)return null!=c?e+this.unpin<=f.top?!1:"bottom":a-d>=e+g?!1:"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&c>=e?"top":null!=d&&i+j>=a-d?"bottom":!1},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);function hideValidateMessage(){var e=$("#messageBoard");e.css("top",-e.outerHeight())}function showValidateMessage(e){var t=$("#messageBoard");t.children("span").children("h3").html(e),t.animate({top:"0"},500)}function resetClick(){document.formc.reset(),postcode(),recalc_onclick("")}function calc(e){var t=JSON.stringify(e);jQuery.ajax({type:"Post",async:ssc.asyncRecalc,url:[location.protocol,"//",location.host,location.pathname].join("")+"calc",data:t,dataType:"json",contentType:"application/json",success:function(e){populate(e)}})}function recalc_onclick(e){co.XLEW_1_4_2=document.getElementById("XLEW_1_4_2").value,co.XLEW_1_4_3=document.getElementById("XLEW_1_4_3").value,co.XLEW_1_4_4=document.getElementById("XLEW_1_4_4").value,co.XLEW_1_4_5=document.getElementById("XLEW_1_4_5").value,co.XLEW_1_5_1=document.getElementById("XLEW_1_5_1").value,co.XLEW_1_5_2=eeparseFloat(document.getElementById("XLEW_1_5_2").value),co.XLEW_1_5_3=eeparseFloat(document.getElementById("XLEW_1_5_3").value),co.XLEW_1_5_4=eeparseFloat(document.getElementById("XLEW_1_5_4").value),co.RevenueFourthInputNumber=eeparseFloat(document.getElementById("RevenueFourthInputNumber").value),co.XLEW_1_6_1=document.getElementById("XLEW_1_6_1").value,co.XLEW_1_6_2=eeparseFloat(document.getElementById("XLEW_1_6_2").value),co.XLEW_1_7_1=document.getElementById("XLEW_1_7_1").value,co.XLEW_1_7_2=eeparseFloat(document.getElementById("XLEW_1_7_2").value),co.XLEW_1_7_3=eeparseFloat(document.getElementById("XLEW_1_7_3").value),co.XLEW_1_7_4=eeparseFloat(document.getElementById("XLEW_1_7_4").value),co.XLEW_1_7_5=eeparseFloat(document.getElementById("XLEW_1_7_5").value),co.xlew_1_7_8=document.getElementById("xlew_1_7_8").value,co.XLEW_1_8_1=document.getElementById("XLEW_1_8_1").value,co.XLEW_1_8_2=eeparseFloat(document.getElementById("XLEW_1_8_2").value),co.XLEW_1_9_8=document.getElementById("XLEW_1_9_8").value,co.XLEW_1_9_9=eeparseFloatV(document.getElementById("XLEW_1_9_9").value),ssc.recalcSource=e,calc(co)}function populate(co){if(void 0!==co.EE){var widgets=co.EE.eeGlobal;if(1==EE.eeGlobalRevision){EE.eeGlobal=widgets;for(k in widgets)widgets[k].rev=EE.eeGlobalRevision}else for(id in co.EE.eeGlobal)switch(widgets[id].f){case"dynamicDropdown":EE.sscwidget2d(widgets[id].f,widgets[id].id,widgets[id].n1,widgets[id].n2,widgets[id].n3,widgets[id].n4,widgets[id].s1,widgets[id].s2,widgets[id].s3,widgets[id].s4,widgets[id].na1.arr,widgets[id].na1.from_x,widgets[id].na1.from_y,widgets[id].na1.to_x,widgets[id].na1.to_y,widgets[id].na2.arr,widgets[id].na2.from_x,widgets[id].na2.from_y,widgets[id].na2.to_x,widgets[id].na2.to_y,widgets[id].na3.arr,widgets[id].na3.from_x,widgets[id].na3.from_y,widgets[id].na3.to_x,widgets[id].na3.to_y,widgets[id].sa1.arr,widgets[id].sa1.from_x,widgets[id].sa1.from_y,widgets[id].sa1.to_x,widgets[id].sa1.to_y,widgets[id].sa2.arr,widgets[id].sa2.from_x,widgets[id].sa2.from_y,widgets[id].sa2.to_x,widgets[id].sa2.to_y,widgets[id].sa3.arr,widgets[id].sa3.from_x,widgets[id].sa3.from_y,widgets[id].sa3.to_x,widgets[id].sa3.to_y);break;case"renderMaps":case"linkImageCallback":EE.sscwidget1d(widgets[id].f,widgets[id].id,widgets[id].n1,widgets[id].n2,widgets[id].n3,widgets[id].n4,widgets[id].s1,widgets[id].s2,widgets[id].s3,widgets[id].s4,widgets[id].nv1.arr,widgets[id].nv1.from_,widgets[id].nv1.to_,widgets[id].nv2.arr,widgets[id].nv2.from_,widgets[id].nv2.to_,widgets[id].nv3.arr,widgets[id].nv3.from_,widgets[id].nv3.to_,widgets[id].sv1.arr,widgets[id].sv1.from_,widgets[id].sv1.to_,widgets[id].sv2.arr,widgets[id].sv2.from_,widgets[id].sv2.to_,widgets[id].sv3.arr,widgets[id].sv3.from_,widgets[id].sv3.to_)}}document.getElementById("XLEW_1_6_3").value=eedisplayFloat(co.XLEW_1_6_3),document.getElementById("XLEW_1_6_4").value=eedisplayFloat(co.XLEW_1_6_4),document.getElementById("XLEW_1_6_5").value=eedisplayFloat(co.XLEW_1_6_5),document.getElementById("XLEW_1_7_9").value=co.XLEW_1_7_9,document.getElementById("XLEW_1_8_3").value=eedisplayFloat(co.XLEW_1_8_3),document.getElementById("XLEW_1_8_4").value=eedisplayFloat(co.XLEW_1_8_4),document.getElementById("XLEW_1_8_5").value=eedisplayFloat(co.XLEW_1_8_5),document.getElementById("XLEW_1_9_7").value=co.XLEW_1_9_7,document.getElementById("XLEW_1_10_7").value=eedisplayFloat(co.XLEW_1_10_7),co=co,initializechart(co),chart("all"),void 0!==co.fnCalls&&co.fnCalls.forEach(function(element,index,array){eval(element)})}function postcode(){document.getElementById("XLEW_1_7_1").value="Industry average revenue",document.getElementById("XLEW_1_8_1").value="Industry Average Profit",document.getElementById("XLEW_1_9_9").value="obtener numero de ceudla"}function TriggerOnchange(e){var t=jQuery.Event("change");$("#"+e).trigger(t)}function myIsNaN(e){return isNaN(e)||"number"==typeof e&&!isFinite(e)}function mod(e,t){return e-t*Math.floor(e/t)}function round(e,t){if(isFinite(e)&&isFinite(t)){var r=0>e?-1:1,a=Math.abs(e),n=Math.pow(10,t);return r*Math.round(a*n)/n}return NaN}function s2n(e){e=String(e).replace(eedecreg,"."),e=e.replace(eethreg,""),e=e.replace(eecurrencyreg,"");var t=parseFloat(e);return myIsNaN(t)&&(t=0),e.search(eepercentreg)>=0&&(t/=100),t}function n2s(e){return eedisplayFloat(e)}function b2s(e){return e?eetrue:eefalse}function v2s(e){switch(typeof e){case"number":return myIsNaN(e)?"NaN":n2s(e);case"string":return e;case"boolean":return b2s(e);case"object":return e.constructor==Number?myIsNaN(e)?e:n2s(e):e.constructor==String?e:e.constructor==Boolean?b2s(e):"NaN";default:return"NaN"}}function v2n(e){switch(typeof e){case"number":return e;case"string":return s2n(e);case"boolean":return e?1:0;case"object":return e.constructor==Number?e:e.constructor==String?s2n(e):e.constructor==Boolean?e?1:0:Number.NaN;default:return Number.NaN}}function eeparseFloat(e){e=String(e).replace(eedecreg,".");var t=parseFloat(e);return isNaN(t)?0:t}function eedisplayFloat(e){if(myIsNaN(e))return Number.NaN;var t=String(e);return near0RegExp.test(t)&&(e=round(e,8),t=String(e)),t.replace(/\./g,eedec)}function eedisplayFloatV(e){return""==e?e:isFinite(e)?eedisplayFloat(e):e}function eedisplayScientific(e,t){if(myIsNaN(e))return Number.NaN;var r=String(e.toExponential(t));return r.replace(/\./g,eedec)}function eedisplayFloatND(e,t){if(myIsNaN(e))return Number.NaN;var r=round(e,t);if(t>0){var a=String(r);if(-1!=a.indexOf("e"))return a;if(-1!=a.indexOf("E"))return a;var n=a.split(".");if(n.length<2){var i="00000000000000".substring(0,t);return n[0].toString()+eedec+i}var i=(n[1].toString()+"00000000000000").substring(0,t);return n[0].toString()+eedec+i}return r}function eedisplayPercent(e){return myIsNaN(e)?Number.NaN:eedisplayFloat(100*e)+"%"}function eedisplayPercentND(e,t){return myIsNaN(e)?Number.NaN:eedisplayFloatND(100*e,t)+"%"}function eedisplayFloatNDTh(e,t){if(myIsNaN(e))return Number.NaN;var r=round(e,t);if(t>0){var a=String(r);if(-1!=a.indexOf("e"))return a;if(-1!=a.indexOf("E"))return a;var n=a.split("."),i=eeinsertThousand(n[0].toString());if(n.length<2){var s="00000000000000".substring(0,t);return i+eedec+s}var s=(n[1].toString()+"00000000000000").substring(0,t);return i+eedec+s}return eeinsertThousand(r.toString())}function eedisplayPercentNDTh(e,t){return myIsNaN(e)?Number.NaN:eedisplayFloatNDTh(100*e,t)+"%"}function eeparseFloatV(e){if(""==e)return e;if(e=String(e).replace(eedecreg,"."),!eeparseFloatVreg.test(e))return e;var t=parseFloat(e);return isNaN(t)?e:t}function eeinsertThousand(e){if(""==e||e.indexOf("e")>=0)return e;var t="";"-"==e.charAt(0)&&(t="-",e=e.substring(1));for(var r="",a=e.length-1,n=0;a>=n;n++)n>0&&n%3==0&&(r=eeth+r),r=e.charAt(a-n)+r;return t+r}function eedatefmt(e,t){if(!isFinite(t))return Number.NaN;for(var r=0,a=0,n="",i=e.length,s=0;i>s;s++)if(e[s]>31)n+=fmtstrings[e[s]-32];else switch(e[s]){case 2:n+=eemonth(t);break;case 3:a=eemonth(t),10>a&&(n+="0"),n+=a;break;case 4:n+=fmtmonthnamesshort[eemonth(t)-1];break;case 5:n+=fmtmonthnameslong[eemonth(t)-1];break;case 6:n+=eeday(t);break;case 7:a=eeday(t),10>a&&(n+="0"),n+=a;break;case 8:n+=fmtdaynamesshort[weekday(t,1)-1];break;case 9:n+=fmtdaynameslong[weekday(t,1)-1];break;case 10:a=year(t)%100,10>a&&(n+="0"),n+=a;break;case 11:n+=year(t);break;case 12:n+=hour(t);break;case 13:a=hour(t),10>a&&(n+="0"),n+=a;break;case 14:a=hour(t)%12,n+=0==a?"12":a%12;break;case 15:a=hour(t)%12,0==a?n+="12":(10>a&&(n+="0"),n+=a);break;case 16:n+=minute(t);break;case 17:a=minute(t),10>a&&(n+="0"),n+=a;break;case 18:n+=second(t);break;case 19:a=second(t),10>a&&(n+="0"),n+=a;break;case 21:case 22:n+=hour(t)<12?"AM":"PM";break;case 23:n+=eedisplayFloat(t);break;case 24:a=e[++s],n+=eedisplayFloatND(t,a);break;case 25:a=e[++s],n+=eedisplayFloatNDTh(t,a);break;case 26:n+=eedisplayPercent(t);break;case 27:a=e[++s],n+=eedisplayPercentND(t,a);break;case 28:a=e[++s],n+=eedisplayPercentNDTh(t,a);break;case 29:a=e[++s],n+=eedisplayScientific(t,a);break;case 30:r=e[++s],a=hour(t)+24*Math.floor(t),a=a.toString(),a.length<r&&(n+="00000000000000".substring(0,r-a.length)),n+=a}return n}function eedatefmtv(e,t){return""==t?t:isFinite(t)?eedatefmt(e,t):t}function leap_gregorian(e){return e%4==0&&!(e%100==0&&e%400!=0)}function gregorian_to_jd(e,t,r){return GREGORIAN_EPOCH-0+365*(e-1)+Math.floor((e-1)/4)+-Math.floor((e-1)/100)+Math.floor((e-1)/400)+Math.floor((367*t-362)/12+(2>=t?0:leap_gregorian(e)?-1:-2)+r)}function jd_to_gregorian(e){var t,r,a,n,i,s,o,c,d,l,u,_;t=Math.floor(e),r=t-GREGORIAN_EPOCH-1,a=Math.floor(r/146097),n=mod(r,146097),i=Math.floor(n/36524),s=mod(n,36524),o=Math.floor(s/1461),c=mod(s,1461),d=Math.floor(c/365),l=400*a+100*i+4*o+d,4!=i&&4!=d&&l++,u=t-gregorian_to_jd(l,1,1),_=t<gregorian_to_jd(l,3,1)?0:leap_gregorian(l)?1:2;var f=Math.floor((12*(u+_)+373)/367),g=t-gregorian_to_jd(l,f,1)+1;return new Array(l,f,g)}function eeday(e){if(!isFinite(e))return Number.NaN;if(1>e)return 0;e>60&&e--;var t=jd_to_gregorian(e+2415020);return t[2]}function hour(e){if(!isFinite(e))return Number.NaN;var t=Math.floor(86400*(e-Math.floor(e))+.5);return Math.floor(t/3600)}function minute(e){if(!isFinite(e))return Number.NaN;var t=Math.floor(86400*(e-Math.floor(e))+.5);return Math.floor(t/60)%60}function eemonth(e){if(!isFinite(e))return Number.NaN;if(1>e)return 1;e>60&&e--;var t=jd_to_gregorian(e+2415020);return t[1]}function second(e){if(!isFinite(e))return Number.NaN;var t=Math.floor(86400*(e-Math.floor(e))+.5);return t%60}function weekday(e,t){if(!isFinite(t)||!isFinite(e))return Number.NaN;if(1>t||t>3)return Number.NaN;var r=Math.floor(e+6)%7;switch(Math.floor(t)){case 1:return r+1;case 2:return(r+6)%7+1;case 3:return(r+6)%7}return"hej"}function year(e){if(!isFinite(e))return Number.NaN;if(1>e)return 1900;e>60&&e--;var t=jd_to_gregorian(e+2415020);return t[0]}function sscgetter(e,t,r,a,n,i,s){var o,c,d,l=new Array;for(c=t;a>=c;c++)for(l[c-t]=new Array,d=r;n>=d;d++)o=e[c][d],l[c-t][d-r]=o;return co[s]=l,1}function sscgetter_numonly(e,t,r,a,n,i,s){var o,c,d,l=new Array;for(c=t;a>=c;c++)for(l[c-t]=new Array,d=r;n>=d;d++)o=e[c][d],l[c-t][d-r]=o;return co[s]=l,1}function chart_S1C1(e){try{var t=[ssc.getCaption("Sheet1!$A$5")].concat(ssc.getValue("Sheet1!$B$5:$E$5_numonly")),r=[ssc.getCaption("Sheet1!$A$7")].concat(ssc.getValue("Sheet1!$B$7:$E$7_numonly")),a=[ssc.getCaption("Sheet1!$A$6")].concat(ssc.getValue("Sheet1!$B$6:$E$6_numonly")),n=[ssc.getCaption("Sheet1!$A$8")].concat(ssc.getValue("Sheet1!$B$8:$E$8_numonly")),i=ssc.getValues(["Sheet1!$B$4:$E$4"],"",ssc.label),s=["#5b9bd5","#a5a5a5","#ed7d31","#ffc000"],o={};o[ssc.getCaption("Sheet1!$A$5")]="bar",o[ssc.getCaption("Sheet1!$A$7")]="bar",o[ssc.getCaption("Sheet1!$A$6")]="line",o[ssc.getCaption("Sheet1!$A$8")]="line";c3.generate({bindto:"#d-S1C1",size:{height:444,width:923},padding:{right:17,top:10},data:{columns:[t,r,a,n],types:o,names:{data0:ssc.getCaption("Sheet1!$A$5"),data1:ssc.getCaption("Sheet1!$A$7"),data2:ssc.getCaption("Sheet1!$A$6"),data3:ssc.getCaption("Sheet1!$A$8")}},axis:{x:{type:"category",categories:i,tick:{fit:!1}},y:{}},grid:{y:{show:!0}},title:{text:"Company against industry"},legend:{show:!0,position:"bottom"},color:{pattern:s}})}catch(c){ssc.exHandler("S1C1")}}function chart(e){var t=!0;if(!ssc.isEmpty(co))try{chart_S1C1(t)}catch(r){exHandler("S1C1")}}function ChangePadding(e,t,r){var a=document.querySelector("#"+r+" svg g .c3-axis-y2").getBoundingClientRect().width;e.internal.config.padding_right=t+a-20,e.flush()}function ColorPieDatalabels(e,t,r){t.forEach(function(t,a){var n="#"+e+" .c3-target-"+t.replace(/[^0-9a-z]/gi,"")+".c3-chart-arc text";$(n).css("fill",r[a])},this)}function GetMaxLegendLength(e,t){var r=e.sort(function(e,t){return t.length-e.length})[0].length;return r*t-10}function PositionRightLegend(e,t){var r=document.querySelector(e+" svg g .c3-legend-item"),a=r.parentNode.getAttribute("transform"),n=SplitTransformValue(a),i=n[0];r.parentNode.setAttribute("transform","translate("+(parseInt(i)+55)+",0)"),document.querySelector(e+" svg").setAttribute("width",t+50)}function SplitTransformValue(e){var t,r="translate(",a=e.indexOf(r),n=e.indexOf(")");if(a>-1){t=e.substring(a+r.length,n);var i=t.split(",");return i}return null}function CheckDatalabelsIfZero(e,t){return t>0?eedatefmt(e,t):null}function GetDatalabelsInsideEnd(e,t,r){for(var a=$("#"+e+" .c3-texts text"),n=$("#"+e+" .c3-shapes path"),i=0;i<n.length;i++)if("bar"===t){var s=a[i].getBoundingClientRect().width,o=n[i].getBoundingClientRect().width;if(parseInt(o)-parseInt(s)<2)d3.select(a[i]).text("");else{var c=d3.select(a[i]).attr("x"),d=parseInt(c);d=r?d-s-5:d-20,d3.select(a[i]).attr("x",d)}}else{var l=a[i].getBoundingClientRect().height,u=n[i].getBoundingClientRect().height;if(parseInt(u)+5<parseInt(l))d3.select(a[i]).text("");else{var c=d3.select(a[i]).attr("y"),d=parseInt(c)+15;d3.select(a[i]).attr("y",d)}}}function GetLegendInfo(e){for(var t=[],r=0;r<e.length;r++){if(!ssc.isXLAddress(e[r]))return e;t.push(ssc.getCaption(e[r]))}return t}function submitClick(e){if(focused=!1,ssc.asyncRecalc=!1,recalc_onclick("submit"),ssc.asyncRecalc=!0,ssc.pendingUploads>0)return alert("Please wait until all attachments have finished uploading."),!1;var t=$(".error").filter(":hiddenByParent").length;if(t>0)return showValidateMessage(ssc.exMsg+" : "+t+(t>1?" errors":" error"),"Form validation"),"function"==typeof ssc.focusOnElement&&ssc.focusOnElement($(".error").first()),!1;var r=[];$("input:file").each(function(e,t){var a=$(this).data("files");r=r.concat(a)});for(var a=r.length,n=0;a>n;n++)$("#formc").append("<input type='hidden' id='"+["xll_fileid"+n]+"' name='"+["xll_fileid"+n]+"' value='"+r[n].id+"'/>");$("#formc").submit()}function printClick(){recalc_onclick(""),$("#printAllTheme").remove(),window.print()}function eequerystring(){var e,t,r,a,n,i;if(n=decodeURI(document.location.search),n.length>0)for(i=n.substring(1).split("&"),a=0;a<i.length;a++)e=i[a].split("="),t=e[0],r=e[1],ssc.formBinder.bind(t,r)}function LoadFromQueryString(){eequerystring();var e=document.location.search;e.length>1&&recalc_onclick("")}function initializechart(e){var t=e.XLEW_1_9_9,r=e.XLEW_1_9_8;arr1xB8E8[0][0]=e.XLEW_1_8_2,arr1xA8A8[0][0]=e.XLEW_1_8_1;var a=e.xlew_1_7_8;arr1xB7E7[0][3]=e.XLEW_1_7_5,arr1xB7E7[0][2]=e.XLEW_1_7_4,arr1xB7E7[0][1]=e.XLEW_1_7_3,arr1xB7E7[0][0]=e.XLEW_1_7_2,arr1xA7A7[0][0]=e.XLEW_1_7_1,arr1xB6E6[0][0]=e.XLEW_1_6_2,arr1xA6A6[0][0]=e.XLEW_1_6_1,arr1xB5E5[0][3]=e.RevenueFourthInputNumber,arr1xB5E5[0][2]=e.XLEW_1_5_4,arr1xB5E5[0][1]=e.XLEW_1_5_3,arr1xB5E5[0][0]=e.XLEW_1_5_2,arr1xA5A5[0][0]=e.XLEW_1_5_1,arr1xB4E4[0][3]=e.XLEW_1_4_5,arr1xB4E4[0][2]=e.XLEW_1_4_4,arr1xB4E4[0][1]=e.XLEW_1_4_3,arr1xB4E4[0][0]=e.XLEW_1_4_2,arr1xB6E6[0][1]=arr1xB5E5[0][1]-arr1xB5E5[0][0],arr1xB6E6[0][2]=arr1xB5E5[0][2]-arr1xB5E5[0][1],arr1xB6E6[0][3]=arr1xB5E5[0][3]-arr1xB5E5[0][2];var n=a;arr1xB8E8[0][1]=arr1xB7E7[0][1]-arr1xB7E7[0][0],arr1xB8E8[0][2]=arr1xB7E7[0][2]-arr1xB7E7[0][1],arr1xB8E8[0][3]=arr1xB7E7[0][3]-arr1xB7E7[0][2];var i=r,s=4*v2n(t);sscgetter(arr1xA5A5,0,0,0,0,"Sheet1!$A$5","Sheet1!$A$5"),sscgetter(arr1xB4E4,0,0,0,3,"Sheet1!$B$4:$E$4","Sheet1!$B$4:$E$4"),sscgetter(arr1xA7A7,0,0,0,0,"Sheet1!$A$7","Sheet1!$A$7"),sscgetter(arr1xA6A6,0,0,0,0,"Sheet1!$A$6","Sheet1!$A$6"),sscgetter(arr1xA8A8,0,0,0,0,"Sheet1!$A$8","Sheet1!$A$8"),sscgetter_numonly(arr1xB5E5,0,0,0,3,"Sheet1!$B$5:$E$5","Sheet1!$B$5:$E$5_numonly"),sscgetter_numonly(arr1xB7E7,0,0,0,3,"Sheet1!$B$7:$E$7","Sheet1!$B$7:$E$7_numonly"),sscgetter_numonly(arr1xB6E6,0,0,0,3,"Sheet1!$B$6:$E$6","Sheet1!$B$6:$E$6_numonly"),sscgetter_numonly(arr1xB8E8,0,0,0,3,"Sheet1!$B$8:$E$8","Sheet1!$B$8:$E$8_numonly");e.XLEW_1_10_7=s,e.XLEW_1_9_7=i,e.XLEW_1_8_5=arr1xB8E8[0][3],e.XLEW_1_8_4=arr1xB8E8[0][2],e.XLEW_1_8_3=arr1xB8E8[0][1],e.XLEW_1_7_9=n,e.XLEW_1_6_5=arr1xB6E6[0][3],e.XLEW_1_6_4=arr1xB6E6[0][2],e.XLEW_1_6_3=arr1xB6E6[0][1]}function navigate(e){var t=e.keyCode|e.which;if(13==t||40==t||38==t){var r=$(e.target||e.srcElement);if(!r.is("textarea")&&(!r.is("select")||38!=t&&40!=t)){for(var a=parseInt(r.attr("data-sheet"),10),n=parseInt(r.attr("data-row"),10),i=parseInt(r.attr("data-col"),10),s=!1,o=$("#sheet-"+a),c='input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea',d=n+1,l=n-1,u=d,_=l;40==t&&u>=d||38==t&&l>=_;){var f=o.find(c).filter("[data-sheet="+a+"][data-row="+(38==t?l:d)+"][data-col="+i+"]");if(f.length>0){f.focus(),f.is("input:text, textarea")&&f.select(),s=!0;break}var g;void 0==o.data("col"+i)?(g=o.find(c).filter("[data-sheet="+a+"][data-col="+i+"]").map(function(){return parseInt($(this).attr("data-row"),10)}).toArray(),o.data("col"+i,g)):g=o.data("col"+i),u=g[g.length-1],_=g[0];var m="indexOf"in Array.prototype?g.indexOf(n):$.inArray(n,g);if(40==t&&u>n)d=g[m+1];else{if(!(38==t&&n>_))break;l=g[m-1]}}if(!s){var h;h=38==t?parseInt(r.attr("tabindex"),10)-1:parseInt(r.attr("tabindex"),10)+1;var E=o.find(c).filter("[data-sheet][data-row][data-col][tabindex="+h+"]");if(E.length>0)E.is(":radio")&&(E=E.filter(":checked")),E.length>0&&(E.focus(),E.is("input:text, textarea")&&E.select());else{var y=o.find(c).filter("[data-sheet][data-row][data-col][tabindex]:first");y.focus(),y.is("input:text, textarea")&&y.select()}}e.preventDefault?e.preventDefault():e.returnValue=!1}}}var ssc=ssc||{};ssc.attachments=[],ssc.pendingUploads=0,ssc.recalcSource="",ssc.APPNAME="combochartex",ssc.exMsg="The fields with the red border are required or invalid.",ssc.asyncRecalc=!0,$(function(){postcode(),ssc.active_sheet_selector="div#panel div.panel-collapse.collapse.in > .panel-body > div.container-fluid.ssc-responsive-sheet > div.row > section",$("#panel").on("shown.bs.collapse",function(){equalheight(ssc.active_sheet_selector),"undefined"!=typeof chart&&chart("all")}),ssc.focusOnElement=function(e){focused||(focused=!0,e.parents(".panel-collapse").hasClass("in")||e.parents(".panel-collapse").collapse("show"),$("html, body").stop().animate({scrollTop:e.offset().top-40},900,"swing",function(){e.focus()}))},$(".btn.btn-sm.button-update").click(function(){recalc_onclick("")}),$(".btn.btn-sm.button-reset").click(function(){resetClick(this)}),$(".btn.btn-sm.button-print.one").click(function(){printClick(this)}),$(".btn.btn-sm.button-submit.spin-button").click(function(){submitClick(this)}),recalc_onclick("");var e=$('input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea,a.ui-state-active');void 0!=e&&0==e.filter(":first").hasClass("form-control")&&e.filter(":first").focus()}),ssc.Dialog={},ssc.Dialog.BeforeSubmitDesc="The form is being submitted.",ssc.Dialog.OfflineHeading="Save until online",ssc.Dialog.OfflineDesc="You are currently offline and the submit failed. Do you want to save the submit and send it later when you are online.",ssc.Dialog.OfflineConfirm="Do you want to save?",ssc.Dialog.OfflineSubmitHeading="Offline forms submit confirmation",ssc.Dialog.OfflineSubmitDesc="There are Offline form(s), which are now ready to submit in server.",ssc.Dialog.OfflineSubmitConfirm="Do you want to submit?",ssc.Dialog.FailOfflineHeading="Offline Form submit failed",ssc.Dialog.FailOfflineDesc="Unable to connect to the Internet. Please try submitting the offline forms later in internet connection.",ssc.Dialog.OfflineSubmitWait="It may take sometime to finish all submits depending on the size of offline forms and internet connection.",ssc.Dialog.OfflineSubmitWaitCounter="Left",ssc.checkIfMSIE=function(){var e=window.navigator.userAgent,t=e.indexOf("MSIE "),r=e.indexOf(".NET CLR");return!(-1===t&&-1===r)},$(window).resize(function(){hideValidateMessage()});var co=new Object,eeisus=1,eetrue="TRUE",eefalse="FALSE",eedec=".",eeth=",",eedecreg=new RegExp("\\.","g"),eethreg=new RegExp(",","g"),eecurrencyreg=new RegExp("[$]","g"),eepercentreg=new RegExp("%","g"),fmtdaynamesshort=new Array("Sun","Mon","Tue","Wed","Thu","Fri","Sat"),fmtdaynameslong=new Array("Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"),fmtmonthnamesshort=new Array("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"),fmtmonthnameslong=new Array("January","February","March","April","May","June","July","August","September","October","November","December"),fmtstrings=new Array,near0RegExp=new RegExp("[.](.*0000000|.*9999999)"),eeparseFloatVreg=new RegExp("^ *-?[0-9.]+ *$"),GREGORIAN_EPOCH=1721425;!function(e){function t(){chart("all")}var r;e(window).resize(function(){clearTimeout(r),r=setTimeout(t,200)})}(jQuery);for(var jsonLocal='{"eeisus":1,"eetrue":"TRUE","eefalse":"FALSE","eedec":".","eeth":",","eedecreg":["\\\\.","g"],"eethreg":[",","g"],"eecurrencyreg":["[$]","g"],"eepercentreg":["%","g"],"fmtdaynamesshort":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"fmtdaynameslong":["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],"fmtmonthnamesshort":["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"fmtmonthnameslong":["January","February","March","April","May","June","July","August","September","October","November","December"],"fmtstrings":[]}',arr1xB4E4=new Array(1),ii=0;1>ii;ii++){arr1xB4E4[ii]=new Array(4);for(var jj=0;4>jj;jj++)arr1xB4E4[ii][jj]=""}for(var arr1xA5A5=new Array(1),ii=0;1>ii;ii++){arr1xA5A5[ii]=new Array(1);for(var jj=0;1>jj;jj++)arr1xA5A5[ii][jj]=""}for(var arr1xB5E5=new Array(1),ii=0;1>ii;ii++){arr1xB5E5[ii]=new Array(4);for(var jj=0;4>jj;jj++)arr1xB5E5[ii][jj]=0}for(var arr1xA6A6=new Array(1),ii=0;1>ii;ii++){arr1xA6A6[ii]=new Array(1);for(var jj=0;1>jj;jj++)arr1xA6A6[ii][jj]=""}for(var arr1xB6E6=new Array(1),ii=0;1>ii;ii++){arr1xB6E6[ii]=new Array(4);for(var jj=0;4>jj;jj++)arr1xB6E6[ii][jj]=0}for(var arr1xA7A7=new Array(1),ii=0;1>ii;ii++){arr1xA7A7[ii]=new Array(1);for(var jj=0;1>jj;jj++)arr1xA7A7[ii][jj]=""}for(var arr1xB7E7=new Array(1),ii=0;1>ii;ii++){arr1xB7E7[ii]=new Array(4);for(var jj=0;4>jj;jj++)arr1xB7E7[ii][jj]=0}for(var arr1xA8A8=new Array(1),ii=0;1>ii;ii++){arr1xA8A8[ii]=new Array(1);for(var jj=0;1>jj;jj++)arr1xA8A8[ii][jj]=""}for(var arr1xB8E8=new Array(1),ii=0;1>ii;ii++){arr1xB8E8[ii]=new Array(4);for(var jj=0;4>jj;jj++)arr1xB8E8[ii][jj]=0}jQuery.expr[":"].hiddenByParent=function(e){if(e.id.startsWith("xl_"))return!0;var t=!1,r=$(e);return void 0!=r&&(t="none"!=r.closest("tr[class^='_css']").css("display")),1==t&&(t="none"!=r.closest(".tab-pane>div").css("display")),t};var ssccf1n=function(e,t,r,a){switch(e){case"image":$("#"+t).attr("src",$("#"+a).attr("src"))}},ssccf4n=function(e,t,r,a,n,i,s){};